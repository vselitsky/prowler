...
variable "region" {
  default = "us-east-2"
  description = "The AWS region to deploy to. Deploying in us-east-2 across the entire demo (sorry)."
}
...
variable "prowler_options" {
  ...
  default = "-r us-east-2 -f us-east-2 -M text,junit-xml,html,csv,json,json-asff -S -q"
}
